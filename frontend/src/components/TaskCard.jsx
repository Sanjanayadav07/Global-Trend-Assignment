    ...
    <>
      ...
      <div className="bg-white p-4 rounded-lg shadow border flex flex-col justify-between">
        <div>
          ...
          <span
            className={`inline-block mt-3 px-3 py-1 text-xs rounded-full ${task.status === "completed"
        ...
        <div className="flex gap-2 mt-4">
          <button
            ...
            className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white rounded-full px-4 py-1.5 text-sm"
          >
